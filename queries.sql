...
/* Select all positive sentiment tweets with the "Barcelona" hashtag  */
SELECT T.Content From Tweets AS T, Hashtags AS H WHERE T.TweetId = H.TweetId AND T.Sentiment = "positive" AND H.Hashtag LIKE '%Barcelona%';
